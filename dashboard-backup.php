    ...
    <body>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', async () => {
                ...
                refreshRequestsBtn.addEventListener('click', fetchDashboardData);
            ...
            function updateStats(stats) {
                ...
                // // Update change indicators (mock data - replace with actual changes)
                // document.getElementById('requestsChange').textContent = '5% from last week';
                // document.getElementById('approvedChange').textContent = '12% from last week';
                // document.getElementById('pendingChange').textContent = '3% from last week';
                // document.getElementById('processingChange').textContent = '8% from last week';
            }
